...
import { indexSession, removeDocument } from '../lib/clinicalSearch.js';
...
router.post('/', authenticateToken, async (req, res, next) => {
    try {
        ...
        indexSession(newSession).catch(() => {}); // Búsqueda semántica: indexar nota
...
router.put('/:id', authenticateToken, async (req, res, next) => {
    try {
        ...
        indexSession(updatedSession).catch(() => {}); // Búsqueda semántica: re-indexar
...
router.delete('/:id', authenticateToken, async (req, res, next) => {
    try {
        ...
        removeDocument('session', id); // Búsqueda semántica: limpiar embedding
